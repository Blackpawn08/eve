    ...
    <form action={dispatch} className="space-y-3">
      <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <SiNamemc className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
            </div>
          </div>
          <div className="mt-4">
            <label
        ...
        <div className="flex justify-center">
          <Link href="/" className="mt-2 cursor-pointer text-blue-500">
...
function SignUpButton() {
  ...
  return (
    <Button className="mt-4 w-full" aria-disabled={pending}>
      Create account <FaArrowRight className="ml-auto h-5 w-5 text-gray-50" />
    </Button>
  );
}
